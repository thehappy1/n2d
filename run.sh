...
python n2d.py fashion 0 --umap_dim=10 --umap_neighbors=20 --manifold_learner=UMAP  --save_dir=fashion-n2d --umap_min_dist=0.00
...
#python n2d.py fpi 0 --umap_dim=10 --umap_neighbors=20 --manifold_learner=UMAP  --save_dir=fpi-n2d --umap_min_dist=0.00
...
#python n2d.py fashion 0 --ae_weights=fashion-1000-ae_weights_copy.h5  --umap_dim=2 --umap_neighbors=20 --manifold_learner=UMAP  --save_dir=fashion-n2d-viz --umap_min_dist=0.00 --visualize --eval_all
